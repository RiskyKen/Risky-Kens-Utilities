...
public class EntityTeleporterFx extends EntityFX {
	...
	public EntityTeleporterFx(World world, double x, double y, double z, double xV, double yV, double zV, boolean enabled) {
	...
	public EntityTeleporterFx(World world, double x, double y, double z) {
		super(world, x, y, z);
