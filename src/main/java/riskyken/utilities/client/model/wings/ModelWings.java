...
public class ModelWings extends ModelBiped
{
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
  {
	...
	public void render(EntityPlayer player, RenderPlayer renderer, float red, float green, float blue) {
		...
		float mult = 0.0625F;
	    //setRotationAngles(0, 0, 0, 0, 0, 0, player);
	    
	    //setRotation(leftWing, renderer.modelBipedMain.bipedBody);
	    //setRotation(rightWing, renderer.modelBipedMain.bipedBody);
	    
	    //rightWingSmall.render(mult);
	    //leftWingSmall.render(mult);
