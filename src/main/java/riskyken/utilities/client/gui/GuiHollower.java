...
public class GuiHollower extends GuiContainer {
	...
	public void initGui() {
		super.initGui();
		buttonList.clear();
		buttonList.add(new GuiButton(0, this.guiLeft + 36, this.guiTop + 28, 50, 20, "Scan"));
		buttonList.add(new GuiButton(1, this.guiLeft + 96, this.guiTop + 28, 50, 20, "Start"));
		buttonList.add(new GuiCheckBox(2, this.guiLeft + 7, this.guiTop + 64, "check", deviceHollower.isIgnoreMeta()));
		buttonList.add(new GuiCheckBox(3, this.guiLeft + 96, this.guiTop + 64, "check", deviceHollower.isLeaveWalls()));
	}
